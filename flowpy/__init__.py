...
def show_flow_arrows(u, v, min_is_black=True, max_norm=None, sub_factors=None):
    ...
    if sub_factors is None:
        sub_factor_x = int(width/25.5)
        sub_factor_y = int(height/25.5)
    ...
    plt.quiver(x_grid[::sub_factor_x, ::sub_factor_y],
               ...
               -v[::sub_factor_x, ::sub_factor_y], #y-axis is reversed to match image convention
               color="width" if min_is_black else "k")
    plt.ylim(height, 0)
